...
\RightLabel{\scriptsize $\to\ \mathrm{introduction}$}
\UnaryInfC{$\vdash \lambda x.\,e : A \to B$}
\end{prooftree}
...
\RightLabel{\scriptsize $\to\ \mathrm{elimination}$}
\BinaryInfC{$C$}
\RightLabel{\scriptsize $\to\ \mathrm{introduction}^3$}
\UnaryInfC{$A \to C$}
\RightLabel{\scriptsize $\to\ \mathrm{introduction}^2$}
\UnaryInfC{$(B \to C) \to (A \to C)$}
\RightLabel{\scriptsize $\to\ \mathrm{introduction}^1$}
